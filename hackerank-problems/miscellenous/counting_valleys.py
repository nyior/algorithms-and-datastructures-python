...
def counting_valleys(steps, path):
    ...
    u = 0
    d = 0
    is_valley_traversal = False
    valley_traversal_count = 0
    ...
    for step in path:
        ...
        if d > u:
            is_valley_traversal = True
        
        # a complete valley traversal has been made
        if u == d and is_valley_traversal: 
            valley_traversal_count += 1
            is_valley_traversal = False
    
    return valley_traversal_count